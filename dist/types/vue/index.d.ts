...
import type { PSmartContainer } from "../../components/smart-container/smart-container.component.js";
...
This attribute only applies when the calendar is in dialog mode and type not "multiple". */
  "close-on-select"?: PCalendar["closeOnSelect"];
...
be an array. **For this reason, values must not contain spaces.** */
  ...
  /**  */
  "week-starts-with"?: PCalendar["weekStartsWith"];
  /** The select's size. */
  size?: PCalendar["size"];
...
type PDropdownProps = {
  /**  */
  "auto-close"?: PDropdown["autoClose"];
...
type PPaginateProps = {
  ...
  /**  */
  "page-list"?: PPaginate["pageList"];

  /** Emitted when the page changed. */
  "onp-change"?: (e: CustomEvent<never>) => void;
  /** Emitted when the page limit changed. */
  "onp-change-limit"?: (e: CustomEvent<never>) => void;
};
...
This property is reflected as a boolean attribute, `show-search`, on the element. */
  "show-search"?: PSelect["showSearch"];
...
export type CustomElements = {
   ...
   * - **goToPreviousMonth(event: _MouseEvent_)** - Moves the calendar to the previous month.
   * - **goToNextMonth(event: _MouseEvent_)** - Moves the calendar to the next month.
   * - **goToPreviousYear(event: _MouseEvent_)** - Moves the calendar to the previous year.
   * - **goToNextYear(event: _MouseEvent_)** - Moves the calendar to the next year.
   *
   * ### **Slots:**
   ...
   * - **p-change-limit** - Emitted when the page limit changed.
   *
   * ### **Slots:**
   *  - **prefix** - A presentational prefix icon or similar element.
   * - **suffix** - A presentational suffix icon or similar element.
   ...
   */
  "p-smart-container": DefineComponent<PSmartContainerProps>;
