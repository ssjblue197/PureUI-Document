...
} from "./chunk.OBOC5VK3.js";
import {
  PPaginate
} from "./chunk.TEYQ775J.js";
import {
  icon_default
} from "./chunk.HY4BQVZY.js";
import {
  PCheckbox
} from "./chunk.DBWUXK62.js";
import {
  se
} from "./chunk.VA36342L.js";
import {
  PTag
} from "./chunk.F6FWDGCP.js";
import {
  LocalizeController
...
var PTable = class extends PureElement {
  ...
  handleChangeLimit(e2) {
    var _a;
    e2 == null ? void 0 : e2.preventDefault();
    e2 == null ? void 0 : e2.stopPropagation();
    const limit = Number((_a = e2.detail) == null ? void 0 : _a.limit);
    this.limit = limit;
    this.page = 1;
  ...
  handleRowClick(e2, r2) {
    e2.stopPropagation();
    this.emit("click", { detail: { row: r2 } });
  }
  handleExpandRow(e2, rIndex) {
    e2.preventDefault();
    e2.stopPropagation();
  ...
  render() {
    ...
    >
      ...
      table: true
        ...
        part="table"
        style="grid-template-columns: repeat(${this.options.columns.length + (((_a = this.options) == null ? void 0 : _a.selectable) ? 1 : 0) + (((_b = this.options) == null ? void 0 : _b.expandable) ? 1 : 0)}, auto); max-height: ${((_c = this.options) == null ? void 0 : _c.maxHeight) || "unset"};
          min-height: ${((_d = this.options) == null ? void 0 : _d.minHeight) || "auto"};
          "
      >
        <div
          class=${Rt({
      "table-header": true,
      "table-header--hidden": !!((_e = this.options) == null ? void 0 : _e.hideHeader)
    })}
          part="table-header"
        >
          ${((_f = this.options) == null ? void 0 : _f.selectable) ? ke`
                <div
                  class=${Rt({
      "table-cell": true
    })}
      ...
      (i, index) => ke`
        ...
        borderLeft: (i == null ? void 0 : i.sticky) === "end" ? "1px solid var(--p-color-gray-200)" : "unset",
        borderRight: (i == null ? void 0 : i.sticky) === "start" ? "1px solid var(--p-color-gray-200)" : "unset"
      })}
              >
                ${(i == null ? void 0 : i.headerRender) ? i == null ? void 0 : i.headerRender(i) : i == null ? void 0 : i.headerName}
              </div>
            `
    )}
          ${((_g = this.options) == null ? void 0 : _g.expandable) ? ke`
                <div
                  class=${Rt({
      "table-cell": true,
      ...
      "table-body": true
          ...
          part="table-body"
        >
          ${!this.loading && this.currentItems.length > 0 ? this.currentItems.map((i, rIdx) => {
      var _a2, _b2, _c2, _d2;
      const rowElement = ke`
                  <div
                    class=${Rt({
        "table-row": true
                    ...
                    .data-row=${i}
                    data-row-index=${rIdx}
                    @click=${(e2) => this.handleRowClick(e2, i)}
                  >
        ...
        (k, idx) => ke`
          ...
          borderRight: (k == null ? void 0 : k.sticky) === "start" ? "1px solid var(--p-color-gray-200)" : ""
                    ...
                    ${((_b2 = this.options) == null ? void 0 : _b2.expandable) ? ke`
                          <div
                            class=${Rt({
        "table-cell": true,
        "table-cell--sticky": true
        ...
        // borderLeft: "1px solid var(--p-color-gray-50)",
                            ...
                            @click=${(e2) => {
        var _a3;
        if ((_a3 = this.options) == null ? void 0 : _a3.rowExpandable(i)) {
          this.handleExpandRow(e2, rIdx);
        }
      }}
                          >
                            ${((_c2 = this.options) == null ? void 0 : _c2.rowExpandable) && ((_d2 = this.options) == null ? void 0 : _d2.rowExpandable(i)) ? ke`
      ...
      return ke` <div style="display: contents;">${rowElement} ${rowExpandElement}</div> `;
    }) : ""}
        </div>
      </div>
      ${this.loading ? ke`
      ...
      <div
        class=${Rt({
      "table-footer": true,
      "table-footer--hidden": !!((_h = this.options) == null ? void 0 : _h.hideFooter)
    })}
        part="table-footer"
      >
        <slot name="paginate">
          ${((_i = this.options) == null ? void 0 : _i.paginate) ? ke`
                <p-paginate
                  size="small"
                  variant="default"
                  total=${this.total}
