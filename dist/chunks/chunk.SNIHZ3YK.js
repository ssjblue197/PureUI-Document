...
function generateCalendarGrid(year, month, options) {
  ...
  const lastDayOfPreviousMonth = month === 1 ? new Date(year - 1, 12, 0).getDate() : new Date(year, month - 1, 0).getDate();
  const calendarGrid = [];
  let day = 1;
  ...
  render() {
    ...
    const calendarInline = ke`
      ...
      "calendar__header-button--disabled": this.disabled
        ...
        ${this.interface === "day" ? ke`<div class="calendar__days">
      ...
      return ke` <div class="calendar__day calendar__day--empty"></div> `;
        ...
        ${this.interface === "month" ? ke`<div class="calendar__months">
...
__decorateClass([
  n({ type: String, reflect: true, attribute: "week-starts-with" })
], PCalendar.prototype, "weekStartsWith", 2);
__decorateClass([
  defaultValue()
