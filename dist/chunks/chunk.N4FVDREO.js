...
var M = class _M {
  ...
  _$AI(t3, i4 = this) {
    t3 = N(this, t3, i4), c(t3) ? t3 === T || null == t3 || "" === t3 ? (this._$AH !== T && this._$AR(), this._$AH = T) : t3 !== this._$AH && t3 !== w && this._(t3) : void 0 !== t3._$litType$ ? this.$(t3) : void 0 !== t3.nodeType ? this.T(t3) : u(t3) ? this.k(t3) : this._(t3);
  }
  S(t3) {
  ...
  k(t3) {
    ...
    let s4, e4 = 0;
    for (const h3 of t3)
      e4 === i4.length ? i4.push(s4 = new _M(this.S(l()), this.S(l()), this, this.options)) : s4 = i4[e4], s4._$AI(h3), e4++;
...
var _a;
Z == null ? void 0 : Z(V, M), ((_a = t.litHtmlVersions) != null ? _a : t.litHtmlVersions = []).push("3.1.4");
var j = (t3, i4, s4) => {
  var _a6, _b2;
