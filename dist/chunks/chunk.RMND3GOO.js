import {
  PTag
} from "./chunk.DBZLYSYO.js";
import {
  select_styles_default
} from "./chunk.QRAPQPK4.js";
import {
  o
    ...
    this.handleDocumentKeyDown = (event) => {
      ...
      if (["ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) {
        ...
        allOptions.forEach((option) => {
          option.hidden = !option.getTextLabel().toLowerCase().includes(this.typeToSelectString.toLowerCase()) && !option.value.toLowerCase().includes(this.typeToSelectString.toLowerCase());
        });
      ...
      if (index < this.maxOptionsVisible || this.maxOptionsVisible <= 0) {
        ...
        return x`
          <p-dropdown placement="top" active>
            ...
            <div class="select__tags--overflow" @click=${(e3) => e3.stopPropagation()}>
