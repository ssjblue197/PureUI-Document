  ...
  render() {
    ...
    return ke`
      ...
      >
        ...
        ${this.caret ? ke` <p-icon part="caret" class="button__caret" library="system" name="caret"></p-icon> ` : ""}
        ${this.loading ? ke`<p-spinner part="spinner"></p-spinner>` : ""}
      </${tag}>
    `;
  }
};
