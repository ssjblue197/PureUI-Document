...
function* oo2(o, t2, e2 = 1) {
  const i = void 0 === t2 ? 0 : o;
  t2 != null ? t2 : t2 = o;
  for (let o2 = i; e2 > 0 ? o2 < t2 : t2 < o2; o2 += e2)
    yield o2;
}

// src/components/carousel/carousel.component.ts
var PCarousel = class extends PureElement {
  constructor() {
    super(...arguments);
    this.loop = false;
...
PCarousel.styles = [component_styles_default, carousel_styles_default];
PCarousel.dependencies = { "p-icon": PIcon };
__decorateClass([
  n({ type: Boolean, reflect: true })
], PCarousel.prototype, "loop", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], PCarousel.prototype, "navigation", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], PCarousel.prototype, "pagination", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], PCarousel.prototype, "autoplay", 2);
__decorateClass([
  n({ type: Number, attribute: "autoplay-interval" })
], PCarousel.prototype, "autoplayInterval", 2);
__decorateClass([
  n({ type: Number, attribute: "slides-per-page" })
], PCarousel.prototype, "slidesPerPage", 2);
__decorateClass([
  n({ type: Number, attribute: "slides-per-move" })
], PCarousel.prototype, "slidesPerMove", 2);
__decorateClass([
  n()
], PCarousel.prototype, "orientation", 2);
__decorateClass([
  n({ type: Boolean, reflect: true, attribute: "mouse-dragging" })
], PCarousel.prototype, "mouseDragging", 2);
__decorateClass([
  e(".carousel__slides")
], PCarousel.prototype, "scrollContainer", 2);
__decorateClass([
  e(".carousel__pagination")
], PCarousel.prototype, "paginationContainer", 2);
__decorateClass([
  r()
], PCarousel.prototype, "activeSlide", 2);
__decorateClass([
  r()
], PCarousel.prototype, "scrolling", 2);
__decorateClass([
  r()
], PCarousel.prototype, "dragging", 2);
__decorateClass([
  t({ passive: true })
], PCarousel.prototype, "handleScroll", 1);
__decorateClass([
  watch("loop", { waitUntilFirstUpdate: true }),
  watch("slidesPerPage", { waitUntilFirstUpdate: true })
], PCarousel.prototype, "initializeSlides", 1);
__decorateClass([
  watch("activeSlide")
], PCarousel.prototype, "handelSlideChange", 1);
__decorateClass([
  watch("slidesPerMove")
], PCarousel.prototype, "updateSlidesSnap", 1);
__decorateClass([
  watch("autoplay")
], PCarousel.prototype, "handleAutoplayChange", 1);
