...
var PPopup = class extends PureElement {
  constructor() {
    super(...arguments);
    this.active = false;
    this.placement = "top";
...
PPopup.styles = [component_styles_default, popup_styles_default];
__decorateClass([
  e(".popup")
], PPopup.prototype, "popup", 2);
__decorateClass([
  e(".popup__arrow")
], PPopup.prototype, "arrowEl", 2);
__decorateClass([
  n()
], PPopup.prototype, "anchor", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], PPopup.prototype, "active", 2);
__decorateClass([
  n({ reflect: true })
], PPopup.prototype, "placement", 2);
__decorateClass([
  n({ reflect: true })
], PPopup.prototype, "strategy", 2);
__decorateClass([
  n({ type: Number })
], PPopup.prototype, "distance", 2);
__decorateClass([
  n({ type: Number })
], PPopup.prototype, "skidding", 2);
__decorateClass([
  n({ type: Boolean })
], PPopup.prototype, "arrow", 2);
__decorateClass([
  n({ attribute: "arrow-placement" })
], PPopup.prototype, "arrowPlacement", 2);
__decorateClass([
  n({ attribute: "arrow-padding", type: Number })
], PPopup.prototype, "arrowPadding", 2);
__decorateClass([
  n({ type: Boolean })
], PPopup.prototype, "flip", 2);
__decorateClass([
  n({
...
], PPopup.prototype, "flipFallbackPlacements", 2);
__decorateClass([
  n({ attribute: "flip-fallback-strategy" })
], PPopup.prototype, "flipFallbackStrategy", 2);
__decorateClass([
  n({ type: Object })
], PPopup.prototype, "flipBoundary", 2);
__decorateClass([
  n({ attribute: "flip-padding", type: Number })
], PPopup.prototype, "flipPadding", 2);
__decorateClass([
  n({ type: Boolean })
], PPopup.prototype, "shift", 2);
__decorateClass([
  n({ type: Object })
], PPopup.prototype, "shiftBoundary", 2);
__decorateClass([
  n({ attribute: "shift-padding", type: Number })
], PPopup.prototype, "shiftPadding", 2);
__decorateClass([
  n({ attribute: "auto-size" })
], PPopup.prototype, "autoSize", 2);
__decorateClass([
  n()
], PPopup.prototype, "sync", 2);
__decorateClass([
  n({ type: Object })
], PPopup.prototype, "autoSizeBoundary", 2);
__decorateClass([
  n({ attribute: "auto-size-padding", type: Number })
], PPopup.prototype, "autoSizePadding", 2);
__decorateClass([
  n({ attribute: "hover-bridge", type: Boolean })
], PPopup.prototype, "hoverBridge", 2);
