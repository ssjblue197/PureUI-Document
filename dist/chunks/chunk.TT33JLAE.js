...
function nn(n2, r2, t) {
  return n2 ? r2(n2) : t == null ? void 0 : t(n2);
}
  ...
  render() {
    ...
    return ke`
      ...
      "tree-item__expand-button--visible": showExpandButton
            ...
            aria-hidden="true"
          >
            ${nn(this.loading, () => ke` <p-spinner part="spinner" exportparts="base:spinner__base"></p-spinner> `)}
