...
var g = Array.isArray;
var $ = (t2) => g(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]);
var x = "[ 	\n\f\r]";
...
function N(t2, i3) {
  ...
  return void 0 !== h ? h.createHTML(i3) : i3;
}
var U = (t2, i3) => {
  ...
  for (let i4 = 0; i4 < s2; i4++) {
    ...
    for (; a2 < s3.length && (n4.lastIndex = a2, l2 = n4.exec(s3), null !== l2); )
      a2 = n4.lastIndex, n4 === T ? "!--" === l2[1] ? n4 = E : void 0 !== l2[1] ? n4 = k : void 0 !== l2[2] ? (M.test(l2[2]) && (h4 = RegExp("</" + l2[2], "g")), n4 = O) : void 0 !== l2[3] && (n4 = O) : n4 === O ? ">" === l2[0] ? (n4 = h4 != null ? h4 : T, c4 = -1) : void 0 === l2[1] ? c4 = -2 : (c4 = n4.lastIndex - l2[2].length, r3 = l2[1], n4 = void 0 === l2[3] ? O : '"' === l2[3] ? j : S) : n4 === j || n4 === S ? n4 = O : n4 === E || n4 === k ? n4 = T : (n4 = O, h4 = void 0);
    const u2 = n4 === O && t2[i4 + 1].startsWith("/>") ? " " : "";
    o3 += n4 === T ? s3 + _ : c4 >= 0 ? (e3.push(r3), s3.slice(0, c4) + f + s3.slice(c4) + v + u2) : s3 + v + (-2 === c4 ? i4 : u2);
  }
    ...
    for (; null !== (e3 = I.nextNode()) && r3.length < n4; ) {
      if (1 === e3.nodeType) {
        ...
        if (M.test(e3.tagName)) {
          ...
          if (i4 > 0) {
            e3.textContent = c ? c.emptyScript : "";
...
function z(t2, i3, s2 = t2, e3) {
  ...
  if (i3 === R)
    return i3;
  let h4 = void 0 !== e3 ? (_a6 = s2.o) == null ? void 0 : _a6[e3] : s2.l;
  const o3 = st(i3) ? void 0 : i3._$litDirective$;
  return (h4 == null ? void 0 : h4.constructor) !== o3 && ((_b2 = h4 == null ? void 0 : h4._$AO) == null ? void 0 : _b2.call(h4, false), void 0 === o3 ? h4 = void 0 : (h4 = new o3(t2), h4._$AT(t2, s2, e3)), void 0 !== e3 ? ((_c = s2.o) != null ? _c : s2.o = [])[e3] = h4 : s2.l = h4), void 0 !== h4 && (i3 = z(t2, h4._$AS(t2, i3.values), h4, e3)), i3;
}
var F = class {
  constructor(t2, i3) {
  ...
  u(t2) {
    var _a6;
    const { el: { content: i3 }, parts: s2 } = this._$AD, e3 = ((_a6 = t2 == null ? void 0 : t2.creationScope) != null ? _a6 : w).importNode(i3, true);
    I.currentNode = e3;
    ...
    for (; void 0 !== r3; ) {
      ...
      o3 !== (r3 == null ? void 0 : r3.index) && (h4 = I.nextNode(), o3++);
    }
...
var et = class _et {
  get _$AU() {
    var _a6, _b2;
    return (_b2 = (_a6 = this._$AM) == null ? void 0 : _a6._$AU) != null ? _b2 : this.v;
  }
  constructor(t2, i3, s2, e3) {
    var _a6;
    this.type = 2, this._$AH = D, this._$AN = void 0, this._$AA = t2, this._$AB = i3, this._$AM = s2, this.options = e3, this.v = (_a6 = e3 == null ? void 0 : e3.isConnected) != null ? _a6 : true;
  }
  get parentNode() {
  ...
  $(t2) {
    ...
    if (((_a6 = this._$AH) == null ? void 0 : _a6._$AD) === e3)
      this._$AH.p(i3);
    else {
  ...
  _$AR(t2 = this._$AA.nextSibling, i3) {
    var _a6;
    for ((_a6 = this._$AP) == null ? void 0 : _a6.call(this, false, true, i3); t2 && t2 !== this._$AB; ) {
  ...
  setConnected(t2) {
    var _a6;
    void 0 === this._$AM && (this.v = t2, (_a6 = this._$AP) == null ? void 0 : _a6.call(this, t2));
  }
};
var G = class {
  get tagName() {
  ...
  _$AI(t2, i3 = this, s2, e3) {
    ...
    if (void 0 === h4)
      ...
      for (t2 = h4[0], n4 = 0; n4 < h4.length - 1; n4++)
        r3 = z(this, e4[s2 + n4], i3, n4), r3 === R && (r3 = this._$AH[n4]), o3 || (o3 = !st(r3) || r3 !== this._$AH[n4]), r3 === D ? t2 = D : t2 !== D && (t2 += (r3 != null ? r3 : "") + h4[n4 + 1]), this._$AH[n4] = r3;
    }
    o3 && !e3 && this.j(t2);
  }
  j(t2) {
    t2 === D ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, t2 != null ? t2 : "");
  }
};
...
var q = class extends G {
  ...
  _$AI(t2, i3 = this) {
    var _a6;
    if ((t2 = (_a6 = z(this, t2, i3, 0)) != null ? _a6 : D) === R)
      return;
  ...
  handleEvent(t2) {
    var _a6, _b2;
    "function" == typeof this._$AH ? this._$AH.call((_b2 = (_a6 = this.options) == null ? void 0 : _a6.host) != null ? _b2 : this.element, t2) : this._$AH.handleEvent(t2);
  }
};
var K = class {
...
var _a;
Re == null ? void 0 : Re(B, et), ((_a = n.litHtmlVersions) != null ? _a : n.litHtmlVersions = []).push("3.2.0");
var Q = (t2, i3, s2) => {
  var _a6, _b2;
  const e3 = (_a6 = s2 == null ? void 0 : s2.renderBefore) != null ? _a6 : i3;
  let h4 = e3._$litPart$;
  if (void 0 === h4) {
    const t3 = (_b2 = s2 == null ? void 0 : s2.renderBefore) != null ? _b2 : null;
    e3._$litPart$ = h4 = new et(i3.insertBefore(lt(), t3), t3, void 0, s2 != null ? s2 : {});
  }
...
var r = (t2) => new n2("string" == typeof t2 ? t2 : t2 + "", void 0, s);
var i = (t2, ...e3) => {
...
var c2 = e ? (t2) => t2 : (t2) => t2 instanceof CSSStyleSheet ? ((t3) => {
  let e3 = "";
...
var { is: i2, defineProperty: e2, getOwnPropertyDescriptor: r2, getOwnPropertyNames: h2, getOwnPropertySymbols: o2, getPrototypeOf: n3 } = Object;
var a = globalThis;
...
var f2 = (t2, s2) => !i2(t2, s2);
var y = { attribute: true, type: String, converter: u, reflect: false, hasChanged: f2 };
var _a2, _b;
(_a2 = Symbol.metadata) != null ? _a2 : Symbol.metadata = Symbol("metadata"), (_b = a.litPropertyMetadata) != null ? _b : a.litPropertyMetadata = /* @__PURE__ */ new WeakMap();
var b = class extends HTMLElement {
  static addInitializer(t2) {
    var _a6;
    this._$Ei(), ((_a6 = this.l) != null ? _a6 : this.l = []).push(t2);
  }
  ...
  static getPropertyDescriptor(t2, s2, i3) {
    var _a6;
    const { get: e3, set: h4 } = (_a6 = r2(this.prototype, t2)) != null ? _a6 : { get() {
      return this[s2];
    }, set(t3) {
      this[s2] = t3;
    } };
  ...
  static getPropertyOptions(t2) {
    var _a6;
    return (_a6 = this.elementProperties.get(t2)) != null ? _a6 : y;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(d("properties"))) {
      const t3 = this.properties, s2 = [...h2(t3), ...o2(t3)];
      for (const i3 of s2)
  ...
  _$Ev() {
    var _a6;
    this._$ES = new Promise((t2) => this.enableUpdating = t2), this._$AL = /* @__PURE__ */ new Map(), this._$E_(), this.requestUpdate(), (_a6 = this.constructor.l) == null ? void 0 : _a6.forEach((t2) => t2(this));
  }
  addController(t2) {
    var _a6, _b3;
    ((_a6 = this._$EO) != null ? _a6 : this._$EO = /* @__PURE__ */ new Set()).add(t2), void 0 !== this.renderRoot && this.isConnected && ((_b3 = t2.hostConnected) == null ? void 0 : _b3.call(t2));
  }
  removeController(t2) {
    var _a6;
    (_a6 = this._$EO) == null ? void 0 : _a6.delete(t2);
  }
  _$E_() {
  ...
  createRenderRoot() {
    var _a6;
    const t2 = (_a6 = this.shadowRoot) != null ? _a6 : this.attachShadow(this.constructor.shadowRootOptions);
    return S2(t2, this.constructor.elementStyles), t2;
  }
  connectedCallback() {
    var _a6, _b3;
    (_a6 = this.renderRoot) != null ? _a6 : this.renderRoot = this.createRenderRoot(), this.enableUpdating(true), (_b3 = this._$EO) == null ? void 0 : _b3.forEach((t2) => {
      var _a7;
      return (_a7 = t2.hostConnected) == null ? void 0 : _a7.call(t2);
    });
  }
  enableUpdating(t2) {
  }
  disconnectedCallback() {
    var _a6;
    (_a6 = this._$EO) == null ? void 0 : _a6.forEach((t2) => {
      var _a7;
      return (_a7 = t2.hostDisconnected) == null ? void 0 : _a7.call(t2);
    });
  }
  ...
  _$EC(t2, s2) {
    ...
    if (void 0 !== e3 && true === i3.reflect) {
      const r3 = (void 0 !== ((_a6 = i3.converter) == null ? void 0 : _a6.toAttribute) ? i3.converter : u).toAttribute(s2, i3.type);
  ...
  _$AK(t2, s2) {
    ...
    if (void 0 !== e3 && this._$Em !== e3) {
      const t3 = i3.getPropertyOptions(e3), r3 = "function" == typeof t3.converter ? { fromAttribute: t3.converter } : void 0 !== ((_a6 = t3.converter) == null ? void 0 : _a6.fromAttribute) ? t3.converter : u;
  ...
  requestUpdate(t2, s2, i3) {
    var _a6;
    if (void 0 !== t2) {
      if (i3 != null ? i3 : i3 = this.constructor.getPropertyOptions(t2), !((_a6 = i3.hasChanged) != null ? _a6 : f2)(this[t2], s2))
        return;
      this.P(t2, s2, i3);
    }
  ...
  P(t2, s2, i3) {
    var _a6;
    this._$AL.has(t2) || this._$AL.set(t2, s2), true === i3.reflect && this._$Em !== t2 && ((_a6 = this._$Ej) != null ? _a6 : this._$Ej = /* @__PURE__ */ new Set()).add(t2);
  }
  async _$ET() {
  ...
  performUpdate() {
    ...
    try {
      t2 = this.shouldUpdate(s2), t2 ? (this.willUpdate(s2), (_b3 = this._$EO) == null ? void 0 : _b3.forEach((t3) => {
        var _a7;
        return (_a7 = t3.hostUpdate) == null ? void 0 : _a7.call(t3);
  ...
  _$AE(t2) {
    ...
    (_a6 = this._$EO) == null ? void 0 : _a6.forEach((t3) => {
      var _a7;
      return (_a7 = t3.hostUpdated) == null ? void 0 : _a7.call(t3);
...
var _a3;
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[d("elementProperties")] = /* @__PURE__ */ new Map(), b[d("finalized")] = /* @__PURE__ */ new Map(), p == null ? void 0 : p({ ReactiveElement: b }), ((_a3 = a.reactiveElementVersions) != null ? _a3 : a.reactiveElementVersions = []).push("2.0.4");
...
var h3 = class extends b {
  ...
  createRenderRoot() {
    ...
    return (_b2 = (_a6 = this.renderOptions).renderBefore) != null ? _b2 : _a6.renderBefore = t2.firstChild, t2;
  }
  update(t2) {
  ...
  connectedCallback() {
    var _a6;
    super.connectedCallback(), (_a6 = this.o) == null ? void 0 : _a6.setConnected(true);
  }
  disconnectedCallback() {
    var _a6;
    super.disconnectedCallback(), (_a6 = this.o) == null ? void 0 : _a6.setConnected(false);
  }
  render() {
    return R;
  }
