...
var PSelect = class extends PureElement {
  ...
  selectionChanged() {
    ...
    if (this.multiple) {
      ...
      this.displayLabel = (_f = (_e = this.selectedOptions[0]) == null ? void 0 : _e.getTextLabel()) != null ? _f : "";
    }
    this.updateComplete.then(() => {
      ...
      "select--large": this.size === "large"
          ...
          >
            ...
            <div class="select__listbox" part="select__listbox">
              ${hasPrependRowSlot ? ke`<slot name="prepend-row" class="listbox__prepend" part="prepend-row"></slot>` : null}
              <div
                id="listbox"
                role="listbox"
                aria-expanded=${this.open ? "true" : "false"}
              ...
              ${hasAppendRowSlot ? ke`<slot name="append-row" class="listbox__append" part="append-row"></slot>` : null}
            </div>
          </p-popup>
        </div>
